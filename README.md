...
![Labs](https://img.shields.io/badge/labs-138%2F~120-blue)
...
### Level 4 — Databases (31 built / 20 planned) ✅
...
23/12, grown well past its original target for deeper MySQL
DBRE coverage) and
...
**138 of ~120 labs are written.** Levels 1 (Linux Basics, 27/21), 2
(Networking, 33/25), 3 (Storage, 15/15), and 4 (Databases, 31/20) are
past their target counts — MySQL (23/12, deliberately grown well past
